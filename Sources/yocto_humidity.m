/*********************************************************************
 *
 * $Id: yocto_humidity.m 11112 2013-04-16 14:51:20Z mvuilleu $
 *
...
static NSMutableDictionary* _HumidityCache = nil;
...
+(YHumidity*) FindHumidity:(NSString*) func
{
    ...
    // Search in cache
    {
        if (_HumidityCache == nil){
            _HumidityCache = [[NSMutableDictionary alloc] init];
        }
        if(nil != [_HumidityCache objectForKey:func]){
            retVal = [_HumidityCache objectForKey:func];
       } else {
           YHumidity *newHumidity = [[YHumidity alloc] initWithFunction:func];
           [_HumidityCache setObject:newHumidity forKey:func];
           retVal = newHumidity;
