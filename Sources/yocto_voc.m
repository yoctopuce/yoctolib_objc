/*********************************************************************
 *
 * $Id: yocto_voc.m 12324 2013-08-13 15:10:31Z mvuilleu $
 *
...
{
//--- (YVoc attributes)
   if(!(self = [super initProtected:@"Voc":func]))
          return nil;
...
+(YVoc*) FindVoc:(NSString*) func
{
    ...
    // Search in cache
    if ([YAPI_YFunctions objectForKey:@"YVoc"] == nil){
        [YAPI_YFunctions setObject:[NSMutableDictionary dictionary] forKey:@"YVoc"];
    }
    if(nil != [[YAPI_YFunctions objectForKey:@"YVoc"] objectForKey:func]){
        retVal = [[YAPI_YFunctions objectForKey:@"YVoc"] objectForKey:func];
    } else {
        retVal = [[YVoc alloc] initWithFunction:func];
        [[YAPI_YFunctions objectForKey:@"YVoc"] setObject:retVal forKey:func];
