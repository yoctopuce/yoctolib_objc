/*********************************************************************
 *
 * $Id: yocto_lightsensor.m 11112 2013-04-16 14:51:20Z mvuilleu $
 *
...
static NSMutableDictionary* _LightSensorCache = nil;
...
+(YLightSensor*) FindLightSensor:(NSString*) func
{
    ...
    // Search in cache
    {
        if (_LightSensorCache == nil){
            _LightSensorCache = [[NSMutableDictionary alloc] init];
        }
        if(nil != [_LightSensorCache objectForKey:func]){
            retVal = [_LightSensorCache objectForKey:func];
       } else {
           YLightSensor *newLightSensor = [[YLightSensor alloc] initWithFunction:func];
           [_LightSensorCache setObject:newLightSensor forKey:func];
           retVal = newLightSensor;
