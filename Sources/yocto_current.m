/*********************************************************************
 *
 * $Id: yocto_current.m 11112 2013-04-16 14:51:20Z mvuilleu $
 *
...
static NSMutableDictionary* _CurrentCache = nil;
...
+(YCurrent*) FindCurrent:(NSString*) func
{
    ...
    // Search in cache
    {
        if (_CurrentCache == nil){
            _CurrentCache = [[NSMutableDictionary alloc] init];
        }
        if(nil != [_CurrentCache objectForKey:func]){
            retVal = [_CurrentCache objectForKey:func];
       } else {
           YCurrent *newCurrent = [[YCurrent alloc] initWithFunction:func];
           [_CurrentCache setObject:newCurrent forKey:func];
           retVal = newCurrent;
