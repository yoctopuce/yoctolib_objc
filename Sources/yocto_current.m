/*********************************************************************
 *
 * $Id: yocto_current.m 12324 2013-08-13 15:10:31Z mvuilleu $
 *
...
{
//--- (YCurrent attributes)
   if(!(self = [super initProtected:@"Current":func]))
          return nil;
...
+(YCurrent*) FindCurrent:(NSString*) func
{
    ...
    // Search in cache
    if ([YAPI_YFunctions objectForKey:@"YCurrent"] == nil){
        [YAPI_YFunctions setObject:[NSMutableDictionary dictionary] forKey:@"YCurrent"];
    }
    if(nil != [[YAPI_YFunctions objectForKey:@"YCurrent"] objectForKey:func]){
        retVal = [[YAPI_YFunctions objectForKey:@"YCurrent"] objectForKey:func];
    } else {
        retVal = [[YCurrent alloc] initWithFunction:func];
        [[YAPI_YFunctions objectForKey:@"YCurrent"] setObject:retVal forKey:func];
