...
-(NSString*) readLine
{
    ...
    res = [self _json_get_string:[NSMutableData dataWithData:[[msgarr objectAtIndex:0] dataUsingEncoding:NSUTF8StringEncoding]]];
    return res;
}
...
-(NSMutableArray*) readMessages:(NSString*)pattern :(int)maxWait
{
    ...
    idx = 0;
    while (idx < msglen) {
        [res addObject:[self _json_get_string:[NSMutableData dataWithData:[[msgarr objectAtIndex:idx] dataUsingEncoding:NSUTF8StringEncoding]]]];
        idx = idx + 1;
    }
    return res;
}
...
-(NSMutableArray*) queryMODBUS:(int)slaveNo :(NSMutableArray*)pduBytes
{
    ...
    if ((int)[reps count] > 1) {
        rep = [self _json_get_string:[NSMutableData dataWithData:[[reps objectAtIndex:0] dataUsingEncoding:NSUTF8StringEncoding]]];
