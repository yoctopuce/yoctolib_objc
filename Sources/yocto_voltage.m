/*********************************************************************
 *
 * $Id: yocto_voltage.m 12324 2013-08-13 15:10:31Z mvuilleu $
 *
...
{
//--- (YVoltage attributes)
   if(!(self = [super initProtected:@"Voltage":func]))
          return nil;
...
+(YVoltage*) FindVoltage:(NSString*) func
{
    ...
    // Search in cache
    if ([YAPI_YFunctions objectForKey:@"YVoltage"] == nil){
        [YAPI_YFunctions setObject:[NSMutableDictionary dictionary] forKey:@"YVoltage"];
    }
    if(nil != [[YAPI_YFunctions objectForKey:@"YVoltage"] objectForKey:func]){
        retVal = [[YAPI_YFunctions objectForKey:@"YVoltage"] objectForKey:func];
    } else {
        retVal = [[YVoltage alloc] initWithFunction:func];
        [[YAPI_YFunctions objectForKey:@"YVoltage"] setObject:retVal forKey:func];
