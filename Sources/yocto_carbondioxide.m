/*********************************************************************
 *
 * $Id: yocto_carbondioxide.m 12324 2013-08-13 15:10:31Z mvuilleu $
 *
...
+(YCarbonDioxide*) FindCarbonDioxide:(NSString*) func
{
    ...
    // Search in cache
    if ([YAPI_YFunctions objectForKey:@"YCarbonDioxide"] == nil){
        [YAPI_YFunctions setObject:[NSMutableDictionary dictionary] forKey:@"YCarbonDioxide"];
    }
    if(nil != [[YAPI_YFunctions objectForKey:@"YCarbonDioxide"] objectForKey:func]){
        retVal = [[YAPI_YFunctions objectForKey:@"YCarbonDioxide"] objectForKey:func];
    } else {
        retVal = [[YCarbonDioxide alloc] initWithFunction:func];
        [[YAPI_YFunctions objectForKey:@"YCarbonDioxide"] setObject:retVal forKey:func];
