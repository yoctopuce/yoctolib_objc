/*********************************************************************
 *
 * $Id: yocto_pressure.m 12324 2013-08-13 15:10:31Z mvuilleu $
 *
...
//--- (YPressure attributes)
   if(!(self = [super initProtected:@"Pressure":func]))
          return nil;
...
{
    YPressure * retVal=nil;
    if(func==nil) return nil;
    // Search in cache
    if ([YAPI_YFunctions objectForKey:@"YPressure"] == nil){
        [YAPI_YFunctions setObject:[NSMutableDictionary dictionary] forKey:@"YPressure"];
    }
    if(nil != [[YAPI_YFunctions objectForKey:@"YPressure"] objectForKey:func]){
        retVal = [[YAPI_YFunctions objectForKey:@"YPressure"] objectForKey:func];
    } else {
        retVal = [[YPressure alloc] initWithFunction:func];
        [[YAPI_YFunctions objectForKey:@"YPressure"] setObject:retVal forKey:func];
