/*********************************************************************
 *
 * $Id: yocto_pressure.m 11112 2013-04-16 14:51:20Z mvuilleu $
 *
...
static NSMutableDictionary* _PressureCache = nil;
...
+(YPressure*) FindPressure:(NSString*) func
{
    ...
    // Search in cache
    {
        if (_PressureCache == nil){
            _PressureCache = [[NSMutableDictionary alloc] init];
        }
        if(nil != [_PressureCache objectForKey:func]){
            retVal = [_PressureCache objectForKey:func];
       } else {
           YPressure *newPressure = [[YPressure alloc] initWithFunction:func];
           [_PressureCache setObject:newPressure forKey:func];
           retVal = newPressure;
