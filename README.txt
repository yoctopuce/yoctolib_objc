/*********************************************************************/
 *
 * Y O C T O P U C E   L I B R A R Y   f o r   O b j e c t i v e - C
 *
 * - - - - - - - - - - - License information: - - - - - - - - - - -
 *
...
Examples/                      Directory with sample programs in Objective-C
Sources/                       Source code of the high-level library (in ObjC)
Sources/yapi/                  Source code of the low-level library (in C)
FILES.txt                      List of files contained in this archive
RELEASE.txt                    Release notes

If you want to build all examples, use the following command:
